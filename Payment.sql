...
CREATE TABLE `Payment` (
  ...
  KEY `fk_Payment_Card_idx` (`CardId`),
  CONSTRAINT `fk_Payment_Card` FOREIGN KEY (`CardId`) REFERENCES `Card` (`CardId`) ON UPDATE CASCADE
